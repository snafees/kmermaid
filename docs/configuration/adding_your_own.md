# czbiohub/nf-kmer-similarity: Configuration for other clusters
...
### Docker
Docker is a great way to run czbiohub/nf-kmer-similarity, as it manages all software installations and allows the pipeline to be run in an identical software environment across a range of systems.
...
process.container = "shub://czbiohub/nf-kmer-similarity"
```
